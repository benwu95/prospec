---
name: prospec-tasks
description: "Break Down Tasks - Decompose implementation plan into an actionable task checklist (tasks.md) — the SDD station after plan, not a generic todo tool. Triggers: break down, task list, work items, how to split, 拆解, 任務, 任務清單, 工作項目, 如何拆分"
---
