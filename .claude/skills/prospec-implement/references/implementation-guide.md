...
- **Why defer:** committing after each task group breaks atomic-by-feature the moment review or verify requires a fix; the provenance order is content finalized → record → commit → archive.
