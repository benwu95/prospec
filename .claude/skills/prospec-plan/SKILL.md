---
name: prospec-plan
description: "Plan Implementation - Convert User Story into technical implementation plan (plan.md) and change specification (delta-spec.md) — the SDD plan station, not ad-hoc architecture discussion. Triggers: plan, architecture, technical plan, 規劃, 架構規劃, 技術規劃"
---
