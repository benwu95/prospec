...
rule (see `prospec/CONSTITUTION.md` → Language Policy, mirrored in `CLAUDE.md`). Talk to the user in
...
4. **Green locally**: `pnpm test`, `pnpm typecheck`, `pnpm lint`, and `prospec check` (14 drift
