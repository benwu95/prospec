...
---
<!-- Generated from src/templates/skills/prospec-knowledge-update.hbs by `prospec agent sync`. Edit the template, not this file — it is overwritten on the next sync. -->
