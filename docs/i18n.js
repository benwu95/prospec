...
(function () {
  ...
  var zh = {
    ...
    'hero.facts.tests': '共 <b>6,202</b> 個測試 · <b>6,198</b> 個通過 · <b>4</b> 個略過',
    ...
    'quickstart.s3.p': '你不需要記住每一步。用自然語言描述；agent 會跑完整條有閘門的 SDD cascade，只在提問、gate 失敗或 circuit breaker、最後的 Tastemaker sign-off，以及（若 opt-in）full scale 變更的 plan 簽核停下。',
