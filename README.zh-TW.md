...
[![測試](https://img.shields.io/badge/測試-2372%20通過-success?style=flat-square)](tests/)
...
**測試覆蓋率**：2372 個測試橫跨 4 大類：
- Unit tests（types + lib + services + cli）：1588 tests
