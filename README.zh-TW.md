...
[![測試](https://img.shields.io/badge/測試-3920%20通過-success?style=flat-square)](tests/)
...
└── templates/    — Handlebars 範本（70 個 .hbs 檔案）
...
**測試覆蓋率**：3920 個測試橫跨 4 大類：
- Unit tests（types + lib + services + cli）：2925 tests
- Contract tests（CLI 輸出 + Skill 格式）：863 tests
