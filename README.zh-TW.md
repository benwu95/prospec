...
[![測試](https://img.shields.io/badge/測試-2129%20通過-success?style=flat-square)](tests/)
...
└── templates/    — Handlebars 範本（62 個 .hbs 檔案）
...
**測試覆蓋率**：2129 個測試橫跨 4 大類：
- Unit tests（types + lib + services + cli）：1392 tests
- Contract tests（CLI 輸出 + Skill 格式）：654 tests
