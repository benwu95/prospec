...
[![測試](https://img.shields.io/badge/測試-4606%20總計-success?style=flat-square)](tests/)
...
**測試覆蓋率**：共 4606 個測試（4602 個通過；4 個略過），橫跨 4 大類：
- Unit tests（types + lib + services + cli）：3282 tests
