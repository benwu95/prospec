...
- **REQ-KNOWLEDGE-020**: Root Level Index File (Feature: `ai-knowledge`) -> ADDED
- **REQ-KNOWLEDGE-021**: Conventions Loading Filtering (Feature: `ai-knowledge`) -> ADDED
- **REQ-AGENT-CONFIG-001**: L0 Navigation Guidance (Feature: `agent-integration`) -> ADDED
