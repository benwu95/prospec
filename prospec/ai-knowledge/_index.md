...
| **tests** | vitest, memfs, unit, integration, contract, e2e, knowledge-format, skill-format, token-corpus | 測試, 單元測試, test suite, 驗證, vitest | Active | 4-layer test suite — 33 files, 641 tests (unit 314 + contract 285 + integration 15 + e2e 27), incl. token-corpus fixtures | Quality gate — validates all layers with pyramid coverage | all |
