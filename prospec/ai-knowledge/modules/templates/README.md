...
| `src/templates/knowledge/raw-scan.md.hbs` | Raw scan output template (header notes it is regenerated by `prospec knowledge init` **and** `prospec knowledge refresh`) |
