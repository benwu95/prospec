...
> Sub-module of [Template Library](./README.md) — the skill-template contract (17 skills, 7 partials, 25 references) and what `agent sync` deploys from it.
