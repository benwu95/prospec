...
> 4-layer test architecture using Vitest + memfs — 28 test files, 488 tests (unit, integration, contract, E2E)
...
| `tests/contract/skill-format.test.ts` | All 11 skills format validation, incl. Output Contract presence (189 tests) |
