...
- [US-43: Agent-facing command help and escaping disclosure](./sdd-workflow/us-43.md)
- [US-44: A Full-Scale Plan Can Pause for a Human Sign-off](./sdd-workflow/us-44.md)
...
- [US-42: One Adjudicator per Change, One Route per Station](./sdd-workflow/us-42.md)
...
|------|--------|--------|--------------|
| 2026-09-25 | add-plan-signoff-pause | ADDED REQ-TYPES-105; ADDED REQ-TYPES-106; ADDED REQ-TYPES-107; ADDED REQ-LIB-086; ADDED REQ-LIB-087; ADDED REQ-LIB-088; ADDED REQ-LIB-089; ADDED REQ-SERVICES-116; ADDED REQ-SERVICES-117; ADDED REQ-SERVICES-118; ADDED REQ-SERVICES-119; ADDED REQ-CLI-056; ADDED REQ-TEMPLATES-236; ADDED REQ-TEMPLATES-237; ADDED REQ-TESTS-124; MODIFIED REQ-TEMPLATES-059; MODIFIED REQ-TEMPLATES-184; MODIFIED REQ-TEMPLATES-185; MODIFIED REQ-TEMPLATES-195; MODIFIED REQ-SERVICES-092; MODIFIED REQ-CLI-039; MODIFIED REQ-CLI-031; MODIFIED REQ-LIB-035; MODIFIED REQ-CLI-053; MODIFIED REQ-SERVICES-104; MODIFIED REQ-TEMPLATES-193; MODIFIED REQ-TYPES-022; MODIFIED REQ-CLI-025; MODIFIED REQ-TEMPLATES-228; MODIFIED REQ-TYPES-091; MODIFIED REQ-TEMPLATES-199; MODIFIED REQ-SERVICES-085; MODIFIED REQ-TEMPLATES-224; MODIFIED REQ-TEMPLATES-200; MODIFIED REQ-TEMPLATES-201 | REQ-TYPES-105, REQ-TYPES-106, REQ-TYPES-107, REQ-LIB-086, REQ-LIB-087, REQ-LIB-088, REQ-LIB-089, REQ-SERVICES-116, REQ-SERVICES-117, REQ-SERVICES-118, REQ-SERVICES-119, REQ-CLI-056, REQ-TEMPLATES-236, REQ-TEMPLATES-237, REQ-TESTS-124, REQ-TEMPLATES-059, REQ-TEMPLATES-184, REQ-TEMPLATES-185, REQ-TEMPLATES-195, REQ-SERVICES-092, REQ-CLI-039, REQ-CLI-031, REQ-LIB-035, REQ-CLI-053, REQ-SERVICES-104, REQ-TEMPLATES-193, REQ-TYPES-022, REQ-CLI-025, REQ-TEMPLATES-228, REQ-TYPES-091, REQ-TEMPLATES-199, REQ-SERVICES-085, REQ-TEMPLATES-224, REQ-TEMPLATES-200, REQ-TEMPLATES-201 |
| 2026-09-20 | freeze-acceptance-evidence | ADDED REQ-TYPES-103; ADDED REQ-TYPES-104; ADDED REQ-LIB-084; ADDED REQ-LIB-085; ADDED REQ-SERVICES-114; ADDED REQ-SERVICES-115; ADDED REQ-TEMPLATES-235; ADDED REQ-TESTS-123; MODIFIED REQ-TEMPLATES-032; MODIFIED REQ-TEMPLATES-150; MODIFIED REQ-TEMPLATES-155; MODIFIED REQ-CLI-029; MODIFIED REQ-SERVICES-087; MODIFIED REQ-CLI-038; MODIFIED REQ-TEMPLATES-180; MODIFIED REQ-SERVICES-076; MODIFIED REQ-TESTS-072; MODIFIED REQ-TEMPLATES-115 | REQ-TYPES-103, REQ-TYPES-104, REQ-LIB-084, REQ-LIB-085, REQ-SERVICES-114, REQ-SERVICES-115, REQ-TEMPLATES-235, REQ-TESTS-123, REQ-TEMPLATES-032, REQ-TEMPLATES-150, REQ-TEMPLATES-155, REQ-CLI-029, REQ-SERVICES-087, REQ-CLI-038, REQ-TEMPLATES-180, REQ-SERVICES-076, REQ-TESTS-072, REQ-TEMPLATES-115 |
| 2026-09-20 | declare-constitution-checks | ADDED REQ-TYPES-102; ADDED REQ-LIB-083; ADDED REQ-SERVICES-113; MODIFIED REQ-TEMPLATES-063; MODIFIED REQ-TEMPLATES-154; MODIFIED REQ-TEMPLATES-157; MODIFIED REQ-TESTS-057 | REQ-TYPES-102, REQ-LIB-083, REQ-SERVICES-113, REQ-TEMPLATES-063, REQ-TEMPLATES-154, REQ-TEMPLATES-157, REQ-TESTS-057 |
| 2026-09-19 | bound-recovery-loops | ADDED REQ-TYPES-101; ADDED REQ-LIB-082; ADDED REQ-TESTS-122; MODIFIED REQ-TYPES-070; MODIFIED REQ-TYPES-086; MODIFIED REQ-LIB-035; MODIFIED REQ-SERVICES-070; MODIFIED REQ-CLI-023; MODIFIED REQ-TEMPLATES-195; MODIFIED REQ-SERVICES-092; MODIFIED REQ-CLI-039 | REQ-TYPES-101, REQ-LIB-082, REQ-TESTS-122, REQ-TYPES-070, REQ-TYPES-086, REQ-LIB-035, REQ-SERVICES-070, REQ-CLI-023, REQ-TEMPLATES-195, REQ-SERVICES-092, REQ-CLI-039 |
| 2026-09-19 | write-review-round-counts | ADDED REQ-LIB-081; ADDED REQ-SERVICES-112; ADDED REQ-TESTS-121; MODIFIED REQ-TYPES-022; MODIFIED REQ-CLI-028; MODIFIED REQ-CLI-025; MODIFIED REQ-SERVICES-098; MODIFIED REQ-TEMPLATES-130; MODIFIED REQ-TEMPLATES-145; MODIFIED REQ-TEMPLATES-163 | REQ-LIB-081, REQ-SERVICES-112, REQ-TESTS-121, REQ-TYPES-022, REQ-CLI-028, REQ-CLI-025, REQ-SERVICES-098, REQ-TEMPLATES-130, REQ-TEMPLATES-145, REQ-TEMPLATES-163 |
| 2026-09-18 | require-green-tests | ADDED REQ-LIB-080; ADDED REQ-TESTS-120; ADDED REQ-TEMPLATES-234; MODIFIED REQ-SERVICES-103; MODIFIED REQ-CLI-028; MODIFIED REQ-SERVICES-098; MODIFIED REQ-SERVICES-086; MODIFIED REQ-TYPES-086; MODIFIED REQ-LIB-057; MODIFIED REQ-CLI-043; MODIFIED REQ-TEMPLATES-161; MODIFIED REQ-TEMPLATES-163; MODIFIED REQ-TEMPLATES-203 | REQ-LIB-080, REQ-TESTS-120, REQ-TEMPLATES-234, REQ-SERVICES-103, REQ-CLI-028, REQ-SERVICES-098, REQ-SERVICES-086, REQ-TYPES-086, REQ-LIB-057, REQ-CLI-043, REQ-TEMPLATES-161, REQ-TEMPLATES-163, REQ-TEMPLATES-203 |
| 2026-09-17 | enter-host-skill-stations | MODIFIED REQ-TEMPLATES-195; MODIFIED REQ-TYPES-087; MODIFIED REQ-LIB-059; MODIFIED REQ-SERVICES-092; MODIFIED REQ-CLI-039; MODIFIED REQ-TESTS-094 | REQ-TEMPLATES-195, REQ-TYPES-087, REQ-LIB-059, REQ-SERVICES-092, REQ-CLI-039, REQ-TESTS-094 |
| 2026-09-16 | generate-station-reference-map | ADDED REQ-SERVICES-111; MODIFIED REQ-CLI-023 | REQ-SERVICES-111, REQ-CLI-023 |
| 2026-09-16 | enrich-help-and-skill-descriptions | ADDED REQ-TYPES-098; ADDED REQ-CLI-054; ADDED REQ-CLI-055; ADDED REQ-LIB-078; ADDED REQ-TESTS-118; MODIFIED REQ-CLI-037 | REQ-TYPES-098, REQ-CLI-054, REQ-CLI-055, REQ-LIB-078, REQ-TESTS-118, REQ-CLI-037 |
| 2026-09-05 | unify-workflow-contracts | ADDED REQ-TYPES-096; ADDED REQ-LIB-077; ADDED REQ-SERVICES-109; ADDED REQ-CLI-053; ADDED REQ-TEMPLATES-228; ADDED REQ-TESTS-113; MODIFIED REQ-TYPES-022; MODIFIED REQ-TYPES-070; MODIFIED REQ-LIB-035; MODIFIED REQ-SERVICES-070; MODIFIED REQ-CLI-023; MODIFIED REQ-LIB-071; MODIFIED REQ-SERVICES-102; MODIFIED REQ-TEMPLATES-131; MODIFIED REQ-CLI-025; MODIFIED REQ-SERVICES-091; MODIFIED REQ-TEMPLATES-192; MODIFIED REQ-TEMPLATES-193; MODIFIED REQ-TESTS-093; MODIFIED REQ-TEMPLATES-182; MODIFIED REQ-TEMPLATES-187; MODIFIED REQ-TEMPLATES-137 | REQ-TYPES-096, REQ-LIB-077, REQ-SERVICES-109, REQ-CLI-053, REQ-TEMPLATES-228, REQ-TESTS-113, REQ-TYPES-022, REQ-TYPES-070, REQ-LIB-035, REQ-SERVICES-070, REQ-CLI-023, REQ-LIB-071, REQ-SERVICES-102, REQ-TEMPLATES-131, REQ-CLI-025, REQ-SERVICES-091, REQ-TEMPLATES-192, REQ-TEMPLATES-193, REQ-TESTS-093, REQ-TEMPLATES-182, REQ-TEMPLATES-187, REQ-TEMPLATES-137 |
| 2026-09-05 | verified-input-evidence | MODIFIED REQ-TESTS-057; MODIFIED REQ-TYPES-053; MODIFIED REQ-TYPES-066; MODIFIED REQ-CLI-029; MODIFIED REQ-SERVICES-100; MODIFIED REQ-TEMPLATES-131; MODIFIED REQ-LIB-071; MODIFIED REQ-SERVICES-102; MODIFIED REQ-SERVICES-070; MODIFIED REQ-SERVICES-095; MODIFIED REQ-CHNG-004; MODIFIED REQ-TEMPLATES-129; MODIFIED REQ-TEMPLATES-083; MODIFIED REQ-TEMPLATES-045; MODIFIED REQ-TEMPLATES-034; MODIFIED REQ-TEMPLATES-154 | REQ-TESTS-057, REQ-TYPES-053, REQ-TYPES-066, REQ-CLI-029, REQ-SERVICES-100, REQ-TEMPLATES-131, REQ-LIB-071, REQ-SERVICES-102, REQ-SERVICES-070, REQ-SERVICES-095, REQ-CHNG-004, REQ-TEMPLATES-129, REQ-TEMPLATES-083, REQ-TEMPLATES-045, REQ-TEMPLATES-034, REQ-TEMPLATES-154 |
...
| 2026-09-01 | refresh-v2-documentation | MODIFIED REQ-TESTS-070 | REQ-TESTS-070 |
| 2026-08-31 | enforce-subagent-receipt-verification | ADDED REQ-TEMPLATES-224; ADDED REQ-TESTS-107; ADDED REQ-TESTS-108; MODIFIED REQ-TEMPLATES-155; MODIFIED REQ-TEMPLATES-182; MODIFIED REQ-TEMPLATES-183; MODIFIED REQ-TEMPLATES-184; MODIFIED REQ-TEMPLATES-185; MODIFIED REQ-TEMPLATES-186; MODIFIED REQ-TEMPLATES-187; MODIFIED REQ-TEMPLATES-193; MODIFIED REQ-TEMPLATES-180; MODIFIED REQ-TEMPLATES-181; MODIFIED REQ-TEMPLATES-066 | REQ-TEMPLATES-224, REQ-TESTS-107, REQ-TESTS-108, REQ-TEMPLATES-155, REQ-TEMPLATES-182, REQ-TEMPLATES-183, REQ-TEMPLATES-184, REQ-TEMPLATES-185, REQ-TEMPLATES-186, REQ-TEMPLATES-187, REQ-TEMPLATES-193, REQ-TEMPLATES-180, REQ-TEMPLATES-181, REQ-TEMPLATES-066 |
| 2026-08-31 | give-prose-conventions-executors | ADDED REQ-TESTS-104; ADDED REQ-CLI-049; ADDED REQ-TESTS-105; ADDED REQ-TEMPLATES-222; MODIFIED REQ-LIB-048 | REQ-TESTS-104, REQ-CLI-049, REQ-TESTS-105, REQ-TEMPLATES-222, REQ-LIB-048 |
...
| 2026-08-27 | fix-loop-discipline | ADDED REQ-TYPES-089; ADDED REQ-LIB-063; ADDED REQ-LIB-064; ADDED REQ-SERVICES-098; ADDED REQ-CLI-043; ADDED REQ-TEMPLATES-202; ADDED REQ-TEMPLATES-203; ADDED REQ-TESTS-099; MODIFIED REQ-LIB-057; MODIFIED REQ-TEMPLATES-066; MODIFIED REQ-TEMPLATES-067; MODIFIED REQ-CLI-028 | REQ-TYPES-089, REQ-LIB-063, REQ-LIB-064, REQ-SERVICES-098, REQ-CLI-043, REQ-TEMPLATES-202, REQ-TEMPLATES-203, REQ-TESTS-099, REQ-LIB-057, REQ-TEMPLATES-066, REQ-TEMPLATES-067, REQ-CLI-028 |
...
| 2026-08-20 | situationally-aware-station-transitions | ADDED REQ-TEMPLATES-195; ADDED REQ-TEMPLATES-196; ADDED REQ-TYPES-087; ADDED REQ-LIB-059; ADDED REQ-SERVICES-092; ADDED REQ-CLI-039; ADDED REQ-TESTS-094 | REQ-TEMPLATES-195, REQ-TEMPLATES-196, REQ-TYPES-087, REQ-LIB-059, REQ-SERVICES-092, REQ-CLI-039, REQ-TESTS-094 |
| 2026-08-19 | orchestrate-pipeline-cascading | ADDED REQ-TYPES-086; ADDED REQ-LIB-057; ADDED REQ-LIB-058; ADDED REQ-SERVICES-091; ADDED REQ-TEMPLATES-192; ADDED REQ-TEMPLATES-193; ADDED REQ-TESTS-093 | REQ-TYPES-086, REQ-LIB-057, REQ-LIB-058, REQ-SERVICES-091, REQ-TEMPLATES-192, REQ-TEMPLATES-193, REQ-TESTS-093 |
| 2026-08-19 | formalize-knowledge-update-station | MODIFIED REQ-TYPES-070; MODIFIED REQ-LIB-035; MODIFIED REQ-SERVICES-070 | REQ-TYPES-070, REQ-LIB-035, REQ-SERVICES-070 |
...
| 2026-02-16 | enhance-knowledge-sdd-pipeline | Quality Gate, Brownfield/Greenfield, Technical Summary | US-3, US-8; REQ-TEMPLATES-042~045, REQ-TEMPLATES-205, REQ-TEMPLATES-206 |
...
| 2026-06-12 | add-scale-adapter | proportionate process: scale (quick/standard/full) process scaling + task kind schema frozen + quick dual backstop (BL-004 + OPT-B3/B5/B6) | US-15; REQ-TYPES-026, REQ-TEMPLATES-085~090, REQ-TEMPLATES-209 (ADDED), REQ-CHNG-004/014, REQ-TEMPLATES-010, REQ-SERVICES-010 (MODIFIED) |
