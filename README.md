...
[![Tests](https://img.shields.io/badge/tests-3920%20passing-success?style=flat-square)](tests/)
...
└── templates/    — Handlebars templates (70 .hbs files)
...
**Test Coverage**: 3920 tests across 4 categories:
- Unit tests (types + lib + services + cli): 2925 tests
- Contract tests (CLI output + Skill format): 863 tests
