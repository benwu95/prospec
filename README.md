...
[![Tests](https://img.shields.io/badge/tests-3895%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 3895 tests across 4 categories:
- Unit tests (types + lib + services + cli): 2904 tests
- Contract tests (CLI output + Skill format): 859 tests
