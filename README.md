...
[![Tests](https://img.shields.io/badge/tests-4106%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 4106 tests across 4 categories:
- Unit tests (types + lib + services + cli): 3068 tests
- Contract tests (CLI output + Skill format): 896 tests
