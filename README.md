...
[![Tests](https://img.shields.io/badge/tests-3960%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 3960 tests across 4 categories:
- Unit tests (types + lib + services + cli): 2956 tests
- Contract tests (CLI output + Skill format): 872 tests
