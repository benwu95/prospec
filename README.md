...
[![Tests](https://img.shields.io/badge/tests-1717%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 1717 tests across 4 categories:
- Unit tests (types + lib + services + cli): 1120 tests
- Contract tests (CLI output + Skill format): 540 tests
