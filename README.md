...
[![Tests](https://img.shields.io/badge/tests-4420%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 4420 tests across 4 categories:
- Unit tests (types + lib + services + cli): 3262 tests
- Contract tests (CLI output + Skill format): 982 tests
