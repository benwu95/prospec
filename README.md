...
[![Tests](https://img.shields.io/badge/tests-1818%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 1818 tests across 4 categories:
- Unit tests (types + lib + services + cli): 1190 tests
- Contract tests (CLI output + Skill format): 568 tests
