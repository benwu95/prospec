...
[![Tests](https://img.shields.io/badge/tests-4148%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 4148 tests across 4 categories:
- Unit tests (types + lib + services + cli): 3097 tests
- Contract tests (CLI output + Skill format): 901 tests
