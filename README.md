...
[![Tests](https://img.shields.io/badge/tests-5819%20total-success?style=flat-square)](tests/)
...
```bash
# Run all tests (5819 total; 4 skipped)
pnpm test
...
**Test Coverage**: 5819 total tests (5815 passed; 4 skipped) across 4 categories:
- Unit tests (types + lib + services + cli): 4197 tests
- Contract tests (CLI output + Skill format): 1351 tests
