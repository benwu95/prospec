...
[![Tests](https://img.shields.io/badge/tests-3957%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 3957 tests across 4 categories:
- Unit tests (types + lib + services + cli): 2956 tests
- Contract tests (CLI output + Skill format): 869 tests
