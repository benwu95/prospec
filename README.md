...
[![Tests](https://img.shields.io/badge/tests-3977%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 3977 tests across 4 categories:
- Unit tests (types + lib + services + cli): 2964 tests
- Contract tests (CLI output + Skill format): 881 tests
