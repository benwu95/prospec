...
[![Tests](https://img.shields.io/badge/tests-944%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 944 tests across 4 categories:
- Unit tests (types + lib + services + cli): 447 tests
- Contract tests (CLI output + Skill format): 447 tests
