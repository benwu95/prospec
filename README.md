...
[![Tests](https://img.shields.io/badge/tests-2135%20passing-success?style=flat-square)](tests/)
...
└── templates/    — Handlebars templates (63 .hbs files)
...
**Test Coverage**: 2135 tests across 4 categories:
- Unit tests (types + lib + services + cli): 1392 tests
- Contract tests (CLI output + Skill format): 656 tests
