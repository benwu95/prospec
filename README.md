...
[![Tests](https://img.shields.io/badge/tests-3324%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 3324 tests across 4 categories:
- Unit tests (types + lib + services + cli): 2420 tests
- Contract tests (CLI output + Skill format): 793 tests
