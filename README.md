...
[![Tests](https://img.shields.io/badge/tests-4261%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 4261 tests across 4 categories:
- Unit tests (types + lib + services + cli): 3140 tests
- Contract tests (CLI output + Skill format): 969 tests
