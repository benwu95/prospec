...
[![Tests](https://img.shields.io/badge/tests-3772%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 3772 tests across 4 categories:
- Unit tests (types + lib + services + cli): 2811 tests
- Contract tests (CLI output + Skill format): 831 tests
