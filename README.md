...
[![Tests](https://img.shields.io/badge/tests-3777%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 3777 tests across 4 categories:
- Unit tests (types + lib + services + cli): 2817 tests
- Contract tests (CLI output + Skill format): 830 tests
