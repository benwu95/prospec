...
[![Tests](https://img.shields.io/badge/tests-4606%20total-success?style=flat-square)](tests/)
...
```bash
# Run all tests (4606 total; 4 skipped)
pnpm test
...
**Test Coverage**: 4606 total tests (4602 passed; 4 skipped) across 4 categories:
