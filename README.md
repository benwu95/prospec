...
[![Tests](https://img.shields.io/badge/tests-4474%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 4474 tests across 4 categories:
- Unit tests (types + lib + services + cli): 3262 tests
- Contract tests (CLI output + Skill format): 1036 tests
