...
[![Tests](https://img.shields.io/badge/tests-1991%20passing-success?style=flat-square)](tests/)
...
└── templates/    — Handlebars templates (58 .hbs files)
...
**Test Coverage**: 1991 tests across 4 categories:
- Unit tests (types + lib + services + cli): 1306 tests
- Contract tests (CLI output + Skill format): 604 tests
