...
[![Tests](https://img.shields.io/badge/tests-3888%20passing-success?style=flat-square)](tests/)
...
**Test Coverage**: 3888 tests across 4 categories:
- Unit tests (types + lib + services + cli): 2904 tests
- Contract tests (CLI output + Skill format): 852 tests
